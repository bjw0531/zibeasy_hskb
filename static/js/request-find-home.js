...
(function () {
    ...
    function renderAreaStep() {
        const card = createStepCard('<span style="color: #ef4444;">*</span> 어느 지역을 원하세요? (필수) <span class="text-sm font-normal">(중복선택 가능)</span>');
    ...
    function renderTypeStep() {
        const card = createStepCard('<span style="color: #ef4444;">*</span> 어떤 집을 원하세요? (필수)');
        const field = document.createElement('div');
        field.className = 'fh-field';
    ...
    function renderBudgetStep() {
        const card = createStepCard('<span style="color: #ef4444;">*</span> 어느 가격대로 원하세요? (필수)');
    ...
    function renderMoveInStep() {
        const card = createStepCard('<span style="color: #ef4444;">*</span> 언제 입주를 희망하세요? (필수)');
        const field = document.createElement('div');
    ...
    function renderContactStep() {
        const card = createStepCard('<span style="color: #ef4444;">*</span> 이름과 연락처를 알려주세요. (필수)');
